            ...
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        ...
                        <p class="login-card-description">Silahkan daftar terlebih dahulu !</p>
                        <form action="#!">
                            ...
                            <p class="login-card-footer-text">Sudah mempunyai akun ? <a href="#!" class="text-reset">Login disini</a></p>
